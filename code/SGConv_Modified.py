...
class SGConv_Modified(MessagePassing):
    ...
    def __init__(self, in_channels, out_channels, K=1, cached=False,
                 bias=True):
        super(SGConv_Modified, self).__init__('add')
        ...
        self.lin1 = Linear(in_channels, in_channels, bias=bias)
    ...
    def forward(self, x, edge_index, edge_weight=None):
        """"""
        r = torch.matmul(self.lin1(x), torch.transpose(x, 0, 1))
        ...
        return torch.matmul(r, self.lin2(self.cached_result))
